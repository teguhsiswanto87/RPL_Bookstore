...
echo " 
	...
	";
							...
							$no=$posisi+1;
							$query = "SELECT * FROM books ORDER BY book_id DESC LIMIT $posisi,$batas ";
							$tampil = mysqli_query($konek, $query);
							while ($r=mysqli_fetch_array($tampil)) {
								echo "
								<div class=\"columns panel medium-4 large-3 hover\">";
								...
								echo "	</li>
										...
										<li class=\"beli\">
											...
											if ($r['stock']>0) {
												echo"<input type=\"submit\" name=\"submit\" value=\"Beli\" class=\"button warning tiny radius\">";
											}else{
												# tidak ada tombol BELI karena STOCK HABIS
											}
...
$kueri2     = mysqli_query($konek, "SELECT * FROM books");
...
if ($i != $halaman){
	echo " <a href=\"media.php?buku=all&halaman=$i\" class=\"label radius text-center\">$i</a> | ";
}
else{ 
