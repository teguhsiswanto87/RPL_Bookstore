...
echo " 
	<div class=\"columns large-11 right\">
		<h6> <i class=\"panel\"> Kategori &raquo; Islam & Falsafah &raquo;</i></h6>  
	";
						 
							$no=$posisi+1;
							$query = "SELECT * FROM books WHERE id_genre=6 LIMIT $posisi,$batas ";
							...
							while ($r=mysqli_fetch_array($tampil)) {
								...
								echo "
									...
									$diskon = $r['diskon'];
									$harga_diskon = number_format($harga_normal-($harga_normal*$diskon/60),0,",",".");
								...
								echo "	</li>
										...
										<li class=\"beli\">
											<form method=\"POST\" action=\"$aksi?buku=islamfalsafah&act=input\">
...
$kueri2     = mysqli_query($konek, "SELECT * FROM books WHERE id_genre=6 ");
...
if ($i != $halaman){
	echo " <a href=\"media.php?buku=islamfalsafah&halaman=$i\" class=\"label radius text-center\">$i</a> | ";
}
else{ 
