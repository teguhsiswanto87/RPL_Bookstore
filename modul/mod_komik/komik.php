...
echo " 
	<div class=\"columns large-11 right\">
		<h6> <i class=\"panel\"> Kategori &raquo; Komik & Cerita Bergambar &raquo;</i></h6>  
	";
						 
							$no=$posisi+1;
							$query = "SELECT * FROM books WHERE id_genre=12 LIMIT $posisi,$batas ";
...
$kueri2     = mysqli_query($konek, "SELECT * FROM books WHERE id_genre=12 ");
