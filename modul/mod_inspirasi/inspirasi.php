...
echo " 
	<div class=\"columns large-11 right\">
		<h6> <i class=\"panel\"> Kategori &raquo; Inspirasi & Pengembangan Diri &raquo;</i></h6>  
	";
						 
							$no=$posisi+1;
							$query = "SELECT * FROM books WHERE id_genre=9 LIMIT $posisi,$batas ";
							...
							while ($r=mysqli_fetch_array($tampil)) {
								...
								echo "
									...
									$diskon = $r['diskon'];
									$harga_diskon = number_format($harga_normal-($harga_normal*$diskon/90),0,",",".");
								...
								echo "	</li>
										...
										<li class=\"beli\">
											<form method=\"POST\" action=\"$aksi?buku=inspirasi&act=input\">
...
$kueri2     = mysqli_query($konek, "SELECT * FROM books WHERE id_genre=9 ");
...
if ($i != $halaman){
	echo " <a href=\"media.php?buku=inspirasi&halaman=$i\" class=\"label radius text-center\">$i</a> | ";
}
else{ 
