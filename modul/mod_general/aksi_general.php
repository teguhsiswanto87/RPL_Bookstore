...
if ($module=='books' AND $act=='input' ) {
	...
	if (empty($lokasi_file)) {
		$input 	= "INSERT INTO books(id_genre, book_name, book_price, author, tanggal)
					VALUES('$genre', '$book_name', '$book_price', '$author', '$tgl_sekarang')";
		mysqli_query($konek,$input);
	}else{
		UploadImage($nama_foto);
		$input 	= "INSERT INTO books(id_genre, book_name, book_price, author, tanggal, gambar)
					VALUES('$genre', '$book_name', '$book_price', '$author', '$tgl_sekarang','$nama_foto')";
		mysqli_query($konek,$input);
	}
