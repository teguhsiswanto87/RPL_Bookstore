...
echo " 
	<div class=\"columns large-11 right\">
		<h6> <i class=\"panel\"> Kategori &raquo; Sosial Budaya &raquo;</i></h6>  
	";
						 
							$no=$posisi+1;
							$query = "SELECT * FROM books WHERE id_genre=10 LIMIT $posisi,$batas ";
							...
							while ($r=mysqli_fetch_array($tampil)) {
								...
								echo "	</li>
										...
										<li class=\"beli\">
											<form method=\"POST\" action=\"$aksi?buku=sosbud&act=input\">
...
$kueri2     = mysqli_query($konek, "SELECT * FROM books WHERE id_genre=10 ");
...
if ($i != $halaman){
	echo " <a href=\"media.php?buku=sosbud&halaman=$i\" class=\"label radius text-center\">$i</a> | ";
}
else{ 
